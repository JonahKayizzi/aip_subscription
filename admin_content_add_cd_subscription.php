<div class="content-admin">
    ...
    <div class="row">
        ...
        <form action="processes/add_cd_subscription.php" method="POST" enctype="multipart/form-data">
            <div style="width:500px" class="form-group">
                ...
                <select name="subscriber_id" class="form-control" title="Select Subscriber">
                    ...
                    $sql = "SELECT sub_id, sub_name from subscribers 
                                    WHERE sub_id NOT IN 
                                (select subscriber_id from subscriptions WHERE sub_type = 'CD' AND sub_status != 0)
                                ORDER BY sub_name";
