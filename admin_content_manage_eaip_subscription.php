...
<div class="content-admin">
    ...
    <div class="row">
        ...
        <form action = "processes/edit_eaip_subscription.php" method = "POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input name="eaip_user_name" value='<?php echo $eaip_user_name;?>' type="text" class="form-control" id="exampleInputText1">
            </div>

            <div class="form-group">
                <label for="exampleInputText1">eAIP Password</label>
                <input name="eaip_password" value='<?php echo $eaip_password;?>' type="text" class="form-control" id="exampleInputText1">
            </div>
