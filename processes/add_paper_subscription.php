...
$sql = "INSERT INTO subscriptions 
				(subscriber_id, sub_type, sub_status, sub_start_date, sub_exp_date, sub_amount, receipt_no, invoice_no, subscription_form, subscription_receipt, subscription_invoice)
				VALUES (
					'$sub_id',
					'paper',
					'1',
...
$name = $sub_name;
$from = $sender_email;
$topic = 'NEW UGANDA AIP SUBSCRIPTION';
$message = '
Dear '.$name.',

	AIM Uganda is pleased to inform you that your paper subscription for AIP Uganda has been activated and will remain active for one year from today.
Your Paper AIP has been dispatched today.

Daily NOTAM lists and other resources are available on our website http://aim.caa.co.ug/.
...
window.location.href = '../paper-subscriptions.php?menu=1&submenu=3';
</script>