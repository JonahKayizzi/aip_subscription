<?php
    ...
    set sub_status = 0
    where sub_exp_date < '$todays_date'";
...
<head>
    ...
    <title>AIP Subscription - Dashboard</title>
</head>
        ...
        <div class="outer-admin">
            <div class="wrapper-admin">
                ...
                <?php require_once('admin_sidebar.php');
                      ...
                      require_once('admin_secondary_sidebar.php');

                      require_once('admin_content_paper_subscription.php')
                 ?>
