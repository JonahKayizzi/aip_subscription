...
class SMTPClient {
	...
	/* Server settings */
	protected $smtpHost = "mail.caa.co.ug";
	protected $smtpPort = 587;
	protected $security = false;
	
	/* Sender settings */
	protected $from = "publication@caa.co.ug";
	protected $user = "publication";
	private $_password = "publication";	//write only from outside (via setter)
	/* Mail settings */
	protected $to = null;
	protected $message = "";
	...
	/** Set the server host, port and ask for security (SSL, TLS) if necessary.
	    */
	public function setServer($smtpHost, $smtpPort = 587, $security = false) {
